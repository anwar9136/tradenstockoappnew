...
import {
  require_react
} from "./chunk-MYIZJE6T.js";
import {
  __spreadProps,
  __spreadValues,
  __toESM
} from "./chunk-YJ6GKNUW.js";
...
var H = (e2, t2) => {
  ...
  switch (t2.type) {
    case 0:
      return __spreadProps(__spreadValues({}, e2), { toasts: [t2.toast, ...e2.toasts].slice(0, o2) });
    case 1:
      return __spreadProps(__spreadValues({}, e2), { toasts: e2.toasts.map((r) => r.id === t2.toast.id ? __spreadValues(__spreadValues({}, r), t2.toast) : r) });
    case 2:
      let { toast: s2 } = t2;
      return H(e2, { type: e2.toasts.find((r) => r.id === s2.id) ? 1 : 0, toast: s2 });
    case 3:
      let { toastId: a2 } = t2;
      return __spreadProps(__spreadValues({}, e2), { toasts: e2.toasts.map((r) => r.id === a2 || a2 === void 0 ? __spreadProps(__spreadValues({}, r), { dismissed: true, visible: false }) : r) });
    case 4:
    ...
    case 6:
      ...
      return __spreadProps(__spreadValues({}, e2), { pausedAt: void 0, toasts: e2.toasts.map((r) => __spreadProps(__spreadValues({}, r), { pauseDuration: r.pauseDuration + i2 })) });
  }
};
var v = [];
...
var V = (e2 = {}, t2 = k) => {
  ...
  let i2 = o2.toasts.map((r) => {
    var l2, g2, T;
    return __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, e2), e2[r.type]), r), { removeDelay: r.removeDelay || ((l2 = e2[r.type]) == null ? void 0 : l2.removeDelay) || (e2 == null ? void 0 : e2.removeDelay), duration: r.duration || ((g2 = e2[r.type]) == null ? void 0 : g2.duration) || (e2 == null ? void 0 : e2.duration) || se[r.type], style: __spreadValues(__spreadValues(__spreadValues({}, e2.style), (T = e2[r.type]) == null ? void 0 : T.style), r.style) });
  });
  return __spreadProps(__spreadValues({}, o2), { toasts: i2 });
};
var ie = (e2, t2 = "blank", o2) => __spreadProps(__spreadValues({ createdAt: Date.now(), visible: true, dismissed: false, type: t2, ariaProps: { role: "status", "aria-live": "polite" }, message: e2, pauseDuration: 0 }, o2), { id: (o2 == null ? void 0 : o2.id) || W() });
var P = (e2) => (t2, o2) => {
  let s2 = ie(t2, e2, o2);
...
n2.promise = (e2, t2, o2) => {
  ...
  return typeof e2 == "function" && (e2 = e2()), e2.then((a2) => {
    ...
    return i2 ? n2.success(i2, __spreadValues(__spreadValues({ id: s2 }, o2), o2 == null ? void 0 : o2.success)) : n2.dismiss(s2), a2;
  }).catch((a2) => {
    let i2 = t2.error ? h2(t2.error, a2) : void 0;
    i2 ? n2.error(i2, __spreadValues(__spreadValues({ id: s2 }, o2), o2 == null ? void 0 : o2.error)) : n2.dismiss(s2);
  }), e2;
};
var ce = 1e3;
...
var $ = ({ toast: e2 }) => {
  ...
  return t2 !== void 0 ? typeof t2 == "string" ? b2.createElement(Pe, null, t2) : t2 : o2 === "blank" ? null : b2.createElement(Se, null, b2.createElement(F, __spreadValues({}, s2)), o2 !== "loading" && b2.createElement(be, null, o2 === "error" ? b2.createElement(C, __spreadValues({}, s2)) : b2.createElement(L, __spreadValues({}, s2))));
};
var Re = (e2) => `
...
var N = y.memo(({ toast: e2, position: t2, style: o2, children: s2 }) => {
  let a2 = e2.height ? ke(e2.position || t2 || "top-center", e2.visible) : { opacity: 0 }, i2 = y.createElement($, { toast: e2 }), r = y.createElement(Ie, __spreadValues({}, e2.ariaProps), h2(e2.message, e2));
  return y.createElement(Oe, { className: e2.className, style: __spreadValues(__spreadValues(__spreadValues({}, a2), o2), e2.style) }, typeof s2 == "function" ? s2({ icon: i2, message: r }) : y.createElement(y.Fragment, null, i2, r));
});
m(x.createElement);
...
var Me = (e2, t2) => {
  ...
  return __spreadValues(__spreadValues({ left: 0, right: 0, display: "flex", position: "absolute", transition: E() ? void 0 : "all 230ms cubic-bezier(.21,1.02,.73,1)", transform: `translateY(${t2 * (o2 ? 1 : -1)}px)` }, s2), a2);
};
var Ce = u`
  z-index: 9999;
  > * {
...
var Fe = ({ reverseOrder: e2, position: t2 = "top-center", toastOptions: o2, gutter: s2, children: a2, toasterId: i2, containerStyle: r, containerClassName: l2 }) => {
  ...
  return x.createElement("div", { "data-rht-toaster": i2 || "", style: __spreadValues({ position: "fixed", zIndex: 9999, top: D, left: D, right: D, bottom: D, pointerEvents: "none" }, r), className: l2, onMouseEnter: T.startPause, onMouseLeave: T.endPause }, g2.map((d2) => {
